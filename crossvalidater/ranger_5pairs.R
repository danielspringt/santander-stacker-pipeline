...
for(ii in 1:30){
  ...
  model.name <- paste0("ranger","_mtry_4","_ntree",ranger.ntree)
  ...
  for(i in 1:length(flds)){
    ...
    #------------- Training test------------#
    test <- test.ii
    Pred.test <- predict(forest.cv, test) ### anpassen
...
saveRDS(final, paste0("./cache/",folder,"/","ranger_30grp_","mtry_4","_ntree",ranger.ntree,".RData"))
